...
<template>
  <div class="ziHome">
    <p class="ziTitle">概率论与数理统计资料汇总</p>
    <p></p>
...
export default {
  data: function () {
    return {
      ref: [{
        key: '试题.zip',
        value: 'https://gitee.com/nksckx/gailvlun/raw/master/%E8%AF%95%E9%A2%98.zip'
      },
      {
        key: '课件.zip',
        value: 'https://gitee.com/nksckx/gailvlun/raw/master/%E8%AF%BE%E4%BB%B6.zip'
      },
      {
        key: '概率论与数理统计.pdf',
