...
export default {
  ...
  data: function () {
    return {
      sub: ['体育', '大学语文', '英语', '一元函数微积分', '多元函数微积分/场论',
        '大学物理实验', '大学物理Ⅰ', '大学物理Ⅱ', '大学物理Ⅲ', '大学物理Ⅳ',
        '思想道德修养与法律基础', '马克思主义基本原理', '近现代史纲要', '毛泽东思想理论体系概论',
        'C/C++', 'Java', '数字逻辑', '数据库', '数据结构', '离散数学', '线性代数', '计算机概论',
        '计算机组成原理', '高级语言编程实训', '算法导论', '机器学习导论', '概率论与数理统计'],
      subjects: []
    }
  },
  created () {
